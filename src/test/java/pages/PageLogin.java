...
public class PageLogin {
	...
	public void login(String user, String pass) {
		...
		/*File myScreenshot = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE); //Captura screen
		try {
			FileUtils.copyFile(myScreenshot, new File("LOGIN " + System.currentTimeMillis()+".jpg"));
		} catch (IOException e) {
			e.printStackTrace();
		}*/
	...
	public void verifyFields() {
		List<WebElement> loginFields = driver.findElements(fields); //Crea una lista de elementos de entrada (input)
